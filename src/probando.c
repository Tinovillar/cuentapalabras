...
// Definici�n de la estructura para un nodo trie
...
// Funci�n para crear un nuevo nodo trie
...
// Funci�n para insertar una cadena en el trie
...
// Funci�n para buscar una cadena en el trie
...
// Funci�n para imprimir todas las cadenas en el trie
